    ...
    <div class="col-span-12  min-h-[60vh] bg-zinc-600 rounded-xl bg-editor">
        ...
        <div>
            ...
            @elseif($selectedTabId === 2)
                ...
                <form class="grid grid-cols-12 gap-4 p-4 items-start" id="ram-form" wire:submit="saveServer"
                    data-tab="2">
                    ...
                    <div class="col-span-6 row-start-2 flex flex-col">
                        ...
                        <div
                            ...
                            @foreach ($selectedTraits as $index => $traitName)
                                <span
                                    class="bg-accent text-white px-2 py-1 rounded-md text-xs flex items-center whitespace-nowrap">
                                    {{ $traitName }}
